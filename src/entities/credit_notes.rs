//! SeaORM entity for the `credit_notes` table.
//! Notas de crédito — emitidas para corregir o reducir una factura previa.
//! Son INMUTABLES: nunca se anulan. Si se emitió por error, se compensa con una Nota de Débito.
